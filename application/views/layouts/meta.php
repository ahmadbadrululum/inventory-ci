...
<head>
    ...
    <title>hseo-inventory | <?= $title ?></title>
    <!-- Favicon-->
    <link rel="icon" style="width:10px;" href="http://members.h-seo.com/uploads/company/logo.png" type="image">
    ...
    <link href="<?= base_url('adminbsb/plugins/bootstrap-datepicker/css/bootstrap-datepicker.css') ?>" rel="stylesheet" />
    ...
    <script src="<?= base_url('adminbsb/plugins/bootstrap/js/bootstrap.js ') ?>"></script>
        ...
        <link href="<?= base_url('adminbsb/plugins/bootstrap-select/css/bootstrap-select.css')?>" rel="stylesheet" />
<style>
{
  touch-action: none;
}
