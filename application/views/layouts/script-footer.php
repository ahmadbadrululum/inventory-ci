    ...
    <!-- Select Plugin Js -->
    <script src="<?php // base_url('adminbsb/plugins/bootstrap-select/js/bootstrap-select.js') ?>"></script>
    ...
    <script src="<?= base_url('adminbsb/js/pages/tables/jquery-datatable.js') ?>"></script>
    ...
    <script src="<?= base_url('adminbsb/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js') ?>"></script>

    <!-- Custom Js -->
    <script src="<?= base_url('adminbsb/js/pages/forms/basic-form-elements.js') ?>"></script>
    <script>
